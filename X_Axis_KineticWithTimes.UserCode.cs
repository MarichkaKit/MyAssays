...
{
    public partial class X_Axis_KineticWithTimes
    {
        /// <summary>
        ...
        private void checkAxisProperty(Adapter adapter, string propertyName)
        {
        	...
        	string expectedProperties = String.Concat("Index", "X (Time)", "Y");
        	...
        	Validate.AreEqual(actualProperties, expectedProperties, String.Format("{0} dropdown property has 'X (Time)' item.", propertyName));
        }
