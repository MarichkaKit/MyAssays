...
{
    public partial class UsingIScriptFromProtocolReplaceDotMis
    {
        /// <summary>
        ...
        public void ValidateSaam(string expectedStr)
        {
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains on item 'ProtocolAnalysisDesktop.YourLicense'.", repo.ProtocolAnalysisDesktop.YourLicenseInfo);
            Validate.Attribute(repo.ProtocolAnalysisDesktop.YourLicenseInfo, "NotMatchedText", new Regex(Regex.Escape(expectedStr)));
        }
    }
}