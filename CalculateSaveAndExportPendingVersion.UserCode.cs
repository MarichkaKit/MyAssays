...
{
    public partial class CalculateSaveAndExportPendingVersion
    {
        /// <summary>
        ...
        public void CompareExportedFile(string fileName, string version)
        {
        	ExtractProtocolHelper.DeleteTempFolder();
        	ExtractProtocolHelper.ExtractResultsTo(null, null, fileName + ".assay-results");
        	
        	var pathToResultsXML =  Path.Combine(HelperConstants.getDesktopTempFolder(), version);
